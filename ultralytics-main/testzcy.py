...
def split_dataset(input_image_folder, input_label_folder, output_folder, test_ratio=0.2,seed: int = 42):
    # 创建训练集和验证集文件夹
...
if __name__ == "__main__":
    root = '/mnt/d/Study_File/codezcy/DRLlearning/ultralytics-main/NEU_DET'  # 换成你的实际路径
    # split_dataset(root)
    
    # 使用示例
    # input_image_folder = '/mnt/d/Study_File/codezcy/DRLlearning/ultralytics-main/NEU_DET/images' # 图片路径
    # input_label_folder = '/mnt/d/Study_File/codezcy/DRLlearning/ultralytics-main/NEU_DET/xml' # 标签路径
    # output_folder = '/mnt/d/Study_File/codezcy/DRLlearning/ultralytics-main/NEU_DET/mydata'
    # split_dataset(input_image_folder, input_label_folder, output_folder, test_ratio=0.2)

    print(find_all_categories(root))
